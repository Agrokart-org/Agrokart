...
const firebaseConfig = {
  ...
  authDomain:
    ...
    "fertilizer-89e57.firebaseapp.com",
  projectId: process.env.REACT_APP_FIREBASE_PROJECT_ID || "fertilizer-89e57",
  storageBucket:
    process.env.REACT_APP_FIREBASE_STORAGE_BUCKET ||
    "fertilizer-89e57.firebasestorage.app",
  messagingSenderId:
    process.env.REACT_APP_FIREBASE_MESSAGING_SENDER_ID || "425831974831",
  appId:
    process.env.REACT_APP_FIREBASE_APP_ID ||
    "1:425831974831:web:2ff47c4c1d8ba29f02115a",
  measurementId:
    process.env.REACT_APP_FIREBASE_MEASUREMENT_ID || "G-CZE8YM228D",
};
