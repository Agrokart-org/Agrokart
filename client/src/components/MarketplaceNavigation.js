  ...
  const marketplaceSides = [
    {
      ...
      description:
        "Browse fertilizers, seeds, and farming equipment from verified vendors",
      icon: CustomerIcon,
      color: "primary",
      features: [
        "Browse products",
    ...
    },
    {
      ...
      description:
        "Join our marketplace as a vendor and reach thousands of farmers",
      icon: VendorIcon,
      color: "success",
      features: [
        "Manage inventory",
    ...
    },
    {
      ...
      description:
        "Join our delivery network and earn money by delivering agricultural products",
      icon: DeliveryIcon,
      color: "info",
      features: [
        "Flexible schedule",
    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Box sx={{ textAlign: "center", mb: 6 }}>
        ...
        <Typography variant="h6" color="text.secondary" paragraph>
          A complete three-sided marketplace connecting farmers, vendors, and
          delivery partners
        </Typography>
      ...
      {!isUserLoggedIn() && (
        <Box sx={{ textAlign: "center", mt: 6 }}>
          ...
          <Typography variant="body1" color="text.secondary" paragraph>
            Choose your role and start your journey with India's leading
