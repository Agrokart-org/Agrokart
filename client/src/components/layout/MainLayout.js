...
const MainLayout = ({ children }) => {
  ...
  return (
    ...
    >
        ...
        >
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
            ...
            >
              ...
              >
                <span style={{ color: "#8B5CF6" }}>Agro</span>
                <span style={{ color: "#F97316" }}>kart</span>
              </Typography>
            </Box>
          </Box>
          ...
          >
            ...
            <Button
              ...
              sx={{ color: "#333", textTransform: "none", fontWeight: 500 }}
            >
      ...
      >
        <DialogContent>
          <Typography>Mobile Search Placeholder</Typography>
        </DialogContent>
      </Dialog>
    </Box>
  );
