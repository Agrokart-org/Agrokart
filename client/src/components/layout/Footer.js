      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography
              variant="body2"
              sx={{ color: "grey.400", mb: 2, lineHeight: 1.8 }}
            >
              Empowering farmers with quality agricultural products delivered
              directly to their doorstep. The most trusted partner for modern
              farming.
            </Typography>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
              <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                ...
                <Typography variant="body2" sx={{ color: "grey.400" }}>
                  123 Farming Hub, Agriculture District,
