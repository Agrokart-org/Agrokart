...
const WORKFLOW_TRANSITIONS = {
  ...
  [WORKFLOW_STEPS.PAYMENT_PROCESSING]: [WORKFLOW_STEPS.ORDER_CONFIRMATION],
  ...
  [WORKFLOW_STEPS.DELIVERY_IN_PROGRESS]: [WORKFLOW_STEPS.ORDER_DELIVERED],
...
export const WorkflowProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (path === "/" || path === "/home") {
      ...
      detectedStep = path.includes("/product/")
        ? WORKFLOW_STEPS.PRODUCT_DETAIL
        : WORKFLOW_STEPS.BROWSE_PRODUCTS;
    } else if (path === "/login") {
