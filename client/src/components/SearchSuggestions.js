  ...
  return (
    <Box sx={{ mt: 2 }}>
      ...
      {recentSearches.length > 0 && (
        <Paper
          sx={{ p: 2, mb: 2, bgcolor: alpha(theme.palette.primary.main, 0.02) }}
        >
      ...
      {/* Search Tips */}
      <Paper
        sx={{ p: 2, mt: 2, bgcolor: alpha(theme.palette.info.main, 0.02) }}
      >
        ...
        >
          • Try searching by product name (e.g., "urea", "dap")
          <br />
          • Search by category (e.g., "organic", "nitrogen")
          <br />
          • Search by brand name
          <br />• Use specific terms for better results
        </Typography>
      </Paper>
    </Box>
  );
