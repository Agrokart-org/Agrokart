...
const WorkflowDashboard = () => {
  ...
  const workflowCategories = {
    "User Journey": [
      {
        step: WORKFLOW_STEPS.LANDING,
        label: "Landing Page",
        icon: <HomeIcon />,
        color: "primary",
      },
      {
        step: WORKFLOW_STEPS.BROWSE_PRODUCTS,
        label: "Browse Products",
        icon: <HomeIcon />,
        color: "primary",
      },
      {
        step: WORKFLOW_STEPS.PRODUCT_DETAIL,
    ...
    Authentication: [
      {
        step: WORKFLOW_STEPS.LOGIN_REQUIRED,
        label: "Login Required",
        icon: <LoginIcon />,
        color: "warning",
      },
      {
        step: WORKFLOW_STEPS.PHONE_LOGIN,
        label: "Phone Login",
        icon: <LoginIcon />,
        color: "warning",
      },
      {
        step: WORKFLOW_STEPS.EMAIL_LOGIN,
        label: "Email Login",
        icon: <LoginIcon />,
        color: "warning",
      },
      {
        step: WORKFLOW_STEPS.OTP_VERIFICATION,
        label: "OTP Verification",
        icon: <LoginIcon />,
        color: "warning",
      },
      {
        step: WORKFLOW_STEPS.REGISTRATION,
        label: "Registration",
        icon: <RegisterIcon />,
        color: "warning",
      },
    ...
    "Shopping Flow": [
      {
        step: WORKFLOW_STEPS.ADD_TO_CART,
        label: "Add to Cart",
        icon: <CartIcon />,
        color: "success",
      },
      {
        step: WORKFLOW_STEPS.CART_REVIEW,
        label: "Review Cart",
        icon: <CartIcon />,
        color: "success",
      },
      {
        step: WORKFLOW_STEPS.DELIVERY_DETAILS,
        label: "Delivery Details",
        icon: <DeliveryIcon />,
        color: "success",
      },
      {
        step: WORKFLOW_STEPS.PAYMENT_METHOD,
        label: "Payment Method",
        icon: <PaymentIcon />,
        color: "success",
      },
      {
        step: WORKFLOW_STEPS.PAYMENT_PROCESSING,
        label: "Processing Payment",
        icon: <PaymentIcon />,
        color: "success",
      },
      {
        step: WORKFLOW_STEPS.ORDER_CONFIRMATION,
    ...
    "Post-Order": [
      {
        step: WORKFLOW_STEPS.ORDER_TRACKING,
        label: "Track Order",
        icon: <TrackIcon />,
        color: "info",
      },
      {
        step: WORKFLOW_STEPS.DELIVERY_IN_PROGRESS,
        label: "Delivery in Progress",
        icon: <DeliveryIcon />,
        color: "info",
      },
      {
        step: WORKFLOW_STEPS.ORDER_DELIVERED,
        label: "Order Delivered",
        icon: <ConfirmIcon />,
        color: "info",
      },
      {
        step: WORKFLOW_STEPS.FEEDBACK_RATING,
    ...
    "User Management": [
      {
        step: WORKFLOW_STEPS.PROFILE_MANAGEMENT,
        label: "Profile Management",
        icon: <ProfileIcon />,
        color: "secondary",
      },
      {
        step: WORKFLOW_STEPS.ORDER_HISTORY,
        label: "Order History",
        icon: <TrackIcon />,
        color: "secondary",
      },
      {
        step: WORKFLOW_STEPS.SUPPORT_CHAT,
        label: "Support Chat",
        icon: <ProfileIcon />,
        color: "secondary",
      },
                    ...
                    return (
                      <ListItem key={stepInfo.step} sx={{ py: 0.5 }}>
                        <ListItemIcon sx={{ minWidth: 40 }}>
                          ...
                          >
                            {React.cloneElement(stepInfo.icon, {
                              sx: { fontSize: 16 },
                            })}
                          </Avatar>
                        </ListItemIcon>
