...
const DeliveryDashboardPage = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      console.log(
        "🔍 Fetching delivery dashboard with token:",
      ...
      if (
        ...
        setError(
          "Access denied. Please ensure you are logged in as a delivery partner.",
        );
      } else if (
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
                ...
                availableAssignments: [
                  {
                    ...
                    vendor: {
                      name: "Farm Store",
                      vendorProfile: { businessName: "Green Farm Store" },
                    },
        ...
        <Alert severity="info">
          <Typography variant="body2">
            ...
            <br />
            1. Ensure you are logged in as a delivery partner
            <br />
            2. Check your internet connection
            <br />
            3. Try the "Load Demo Dashboard" to see the interface
            <br />
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Box sx={{ mt: 2, display: "flex", alignItems: "center", gap: 2 }}>
          <Chip
            ...
            icon={
              deliveryPartner.isVerified ? <CheckCircle /> : <LocationIcon />
            }
          />
                  ...
                  >
                    ...
                    <Box sx={{ display: "flex", gap: 1 }}>
                      <IconButton
                        size="small"
                        onClick={() =>
                          navigate(`/delivery/assignments/${assignment._id}`)
                        }
                      >
                        <ViewIcon />
                      </IconButton>
                      <IconButton
                        ...
                        onClick={() =>
                          navigate(
                            `/delivery/assignments/${assignment._id}/navigate`,
                          )
                        }
                      >
                        <NavigateIcon />
          ...
          <Paper sx={{ p: 3 }}>
            ...
            {!isAvailable && (
              <Alert severity="info" sx={{ mb: 2 }}>
                You are currently offline. Turn on availability to see
                assignments.
              </Alert>
            )}
                  ...
                  >
                    <ListItemText
                      ...
                      secondary={
                        <Box>
                          <Typography variant="body2">
                            Pickup:{" "}
                            {assignment.vendor.vendorProfile?.businessName ||
                          ...
                          <Typography variant="body2">
                            Distance: {assignment.distance?.toFixed(1) || "N/A"}{" "}
                            km
                          </Typography>
                        </Box>
                      }
                    ...
                    <Box sx={{ display: "flex", gap: 1 }}>
                      ...
                      <IconButton
                        ...
                        onClick={() =>
                          navigate(
                            `/delivery/assignments/${assignment._id}/preview`,
                          )
                        }
                      >
                        <ViewIcon />
