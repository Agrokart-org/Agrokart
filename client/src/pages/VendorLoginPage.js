  ...
  return (
    <Box
      sx={{
        minHeight: "100vh",
        background:
          "linear-gradient(135deg, #F0FDF4 0%, #FFF8E1 50%, #FFF3E0 100%)",
        py: 4,
      }}
    >
              ...
              <Box component="form" onSubmit={handleSubmit} noValidate>
                ...
                <Divider sx={{ my: 3 }}>
                  <Typography variant="body2" color="text.secondary">
                    New to Agrokart? Register your business to start selling
          ...
          <Grid item xs={12} md={6}>
            <Box sx={{ pl: { md: 4 } }}>
              ...
              <Typography variant="h6" color="text.secondary" sx={{ mb: 4 }}>
                Join thousands of vendors selling agricultural products on
                Agrokart
              </Typography>
              ...
              >
                ...
                <Typography variant="body2" color="text.secondary">
                  • Reach thousands of farmers and agricultural businesses
                  <br />
                  • Easy inventory management and order processing
                  <br />
                  • Competitive commission rates and fast payments
                  <br />• Dedicated vendor support and business analytics
                </Typography>
              </Box>
            </Box>
          </Grid>
