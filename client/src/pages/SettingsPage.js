...
const SettingsPage = () => {
  ...
  const SettingsItem = ({
    ...
    >
      ...
      />
      {action ||
        (onClick && <ChevronRightIcon color="action" fontSize="small" />)}
    </ListItem>
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <List disablePadding>
            ...
            <SettingsItem
              ...
              subtitle={
                mode === "dark"
                  ? t("settingsPage.on", "On")
                  : t("settingsPage.off", "Off")
              }
              action={
                <Switch
                  checked={mode === "dark"}
        ...
        >
          <SectionHeader
            title={t("settingsPage.securityPrivacy", "Security & Privacy")}
          />
          <List disablePadding>
            <SettingsItem
      ...
      >
        <DialogTitle sx={{ fontWeight: "bold" }}>
          {t("settingsPage.selectLanguage", "Select Language")}
        </DialogTitle>
        <DialogContent>
          <RadioGroup
            value={i18n.language}
