...
const DeliveryDashboard = () => {
  ...
  const simulationPath = [
    ...
    { lat: 18.522, lng: 73.858 },
    { lat: 18.5225, lng: 73.8585 },
    { lat: 18.523, lng: 73.859 },
    { lat: 18.5235, lng: 73.8595 },
    { lat: 18.524, lng: 73.86 },
    { lat: 18.5245, lng: 73.8605 },
    { lat: 18.525, lng: 73.861 },
  ];
  ...
  const activeOrder = {
    ...
    vendorPickupPin: "1234", // Placeholder, should be fetched from API
  };
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        <AppBar
          position="sticky"
          sx={{ ...theme.glass(0.9), boxShadow: "none" }}
        >
                ...
                <Stack direction="row" alignItems="center" spacing={0.5}>
                  <Box
                    sx={{
                      ...
                      height: 8,
                      borderRadius: "50%",
                      bgcolor: isOnline ? "#00C853" : "#B0BEC5",
                    }}
                  />
                  <Typography
                    variant="caption"
        ...
        <Menu
          ...
          PaperProps={{
            sx: { borderRadius: 3, boxShadow: "0 8px 24px rgba(0,0,0,0.1)" },
          }}
        >
              ...
              >
                <Card
                  sx={{
                    borderRadius: "32px",
                    background:
                      "linear-gradient(135deg, #263238 0%, #000000 100%)",
                    color: "white",
                    textAlign: "center",
                    py: 8,
                    position: "relative",
                ...
                >
                  <Box sx={{ position: "relative", zIndex: 1 }}>
                    ...
                    <Button
                      variant="contained"
                      onClick={() =>
                        handleOnlineToggle({ target: { checked: true } })
                      }
                      sx={{
                        background: "white",
                        color: "black",
                        ...
                        <Box sx={{ mb: 4 }}>
                          ...
                          >
                            <Typography
                              ...
                              fontWeight="bold"
                            >
                              VENDOR PIN: {activeOrder.vendorPickupPin}
                            </Typography>
                          </Box>
                        </Box>
