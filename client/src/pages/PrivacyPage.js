  ...
  const sections = [
    {
      ...
      text: t(
        "settingsPage.dataCollectionText",
        "We collect information you provide directly to us, such as when you create an account, update your profile, or make a purchase.",
      ),
    },
    {
      ...
      >
        ...
        >
          <Typography variant="body1" color="text.secondary" paragraph>
            {t(
              "settingsPage.privacyIntro",
              "At Agrokart, we take your privacy seriously. This policy describes how we collect, use, and handle your data.",
            )}
          </Typography>
