    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Paper sx={{ p: 4, mb: 4, bgcolor: "info.light" }}>
        ...
        <Typography variant="body1" paragraph>
          This page allows you to test the order confirmation and bill
          generation functionality:
        </Typography>
        <Box component="ul" sx={{ pl: 3 }}>
          <li>
            Add products to cart individually or use the "Test Complete Order"
            button
          </li>
          <li>
            The test order will automatically set delivery details and payment
            method
          </li>
          <li>You'll be redirected to the order confirmation page</li>
          <li>
            On the confirmation page, you can download the bill as PDF or print
            it
          </li>
          <li>
            The bill includes all order details, customer info, and professional
            formatting
          </li>
        </Box>
      </Paper>
          ...
          <Grid item xs={12} md={3}>
            <Paper sx={{ p: 3, bgcolor: "primary.light", color: "white" }}>
              ...
              <Typography variant="body2">
                Complete bill with company details, customer info, and itemized
                products
              </Typography>
            </Paper>
          </Grid>
