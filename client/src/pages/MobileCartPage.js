...
const MobileCartPage = () => {
  ...
  const { cart, updateQuantity, removeFromCart, getCartTotal, cartCount } =
    useCart();
  ...
  if (cartCount === 0) {
    return (
      ...
      >
        ...
        <Typography
          variant="body2"
          sx={{ color: "text.secondary", mb: 4, maxWidth: 250 }}
        >
