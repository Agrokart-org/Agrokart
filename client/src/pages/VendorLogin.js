  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      try {
        ...
        console.log(
          "✅ Firebase vendor authentication successful:",
          firebaseUser.uid,
        );
      } catch (firebaseError) {
        console.warn(
          "⚠️ Firebase vendor authentication failed:",
      ...
      try {
        ...
        if (backendResponse.user && backendResponse.user.role !== "vendor") {
          throw new Error(
            `Access denied. This account is registered as ${backendResponse.user.role}. Please use the ${backendResponse.user.role === "customer" ? "customer" : "delivery partner"} login page.`,
          );
        }
      } catch (backendError) {
        console.error(
      ...
      console.log(
        "✅ Vendor login successful, navigating to vendor dashboard...",
      );
      ...
      if (errorMessage.includes("registered as customer")) {
        ...
        errorMessage =
          "This account is registered as a delivery partner. Please use the delivery partner login page instead.";
      }
