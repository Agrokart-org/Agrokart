  ...
  const faqs = [
    {
      ...
      answer: t(
        "settingsPage.faq1a",
        'You can track your order by going to the "My Orders" section in your profile. Click on any active order to see real-time tracking updates.',
      ),
    },
    {
      ...
      answer: t(
        "settingsPage.faq2a",
        "We accept various payment methods including Credit/Debit cards, UPI, Net Banking, and Cash on Delivery (selected areas only).",
      ),
    },
    {
      ...
      answer: t(
        "settingsPage.faq3a",
        'If you are not satisfied with a product, you can request a return within 7 days of delivery. Go to "My Orders", select the item, and click "Return".',
      ),
    },
    {
      ...
      answer: t(
        "settingsPage.faq4a",
        "Delivery is free for orders above ₹500. For orders below this amount, a nominal delivery fee applies based on your location.",
      ),
    },
  ];
        ...
        >
          <Box sx={{ display: "flex", alignItems: "center", mb: 3 }}>
            ...
            <Typography variant="h5" fontWeight="bold">
              {t(
                "settingsPage.frequentlyAskedQuestions",
