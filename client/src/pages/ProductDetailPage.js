...
const ProductDetailPage = () => {
        ...
        if (id && id.startsWith("seed")) {
          setTimeout(() => {
            setProduct({
              _id: id,
              name:
                id === "seed1" ? "Basmati Rice Seeds" : "Organic Wheat Seeds",
              price: id === "seed1" ? 450 : 350,
              originalPrice: id === "seed1" ? 550 : 450,
              description:
                "Premium quality seeds treated for disease resistance and high yield. Suitable for all soil types. Enhance your farming with our genetically superior seeds.",
              images: [
                "https://placehold.co/600x400/2E7D32/FFFFFF?text=Basmati+Seeds",
                "https://placehold.co/600x400/81C784/FFFFFF?text=Packaging",
                "https://placehold.co/600x400/A5D6A7/FFFFFF?text=Grains",
              ],
              category: "Seeds",
              rating: 4.8,
              numReviews: 142,
              ...
              specifications: {
                ...
                weight: "1 kg",
                usage:
                  "Soak seeds for 24 hours before sowing. maintain 2-3 inches of water level.",
                precautions:
                  "Do not use for human consumption directly. Treated with fungicide.",
              },
            });
            setLoading(false);
          }, 500);
  ...
  const relatedProducts = [
    ...
    },
    {
      ...
      price: 950,
      image:
        "https://placehold.co/400x300/A5D6A7/FFFFFF?text=Micronutrient+Mix",
      category: "Nutrients",
    },
  ];
                    ...
                    <Box>
                      <List disablePadding>
                        {Object.entries(product.specifications || {}).map(
                          ([key, value]) => {
                            if (["usage", "precautions"].includes(key))
                              return null;
                        ...
                        <ListItem divider>
                          ...
                          <Typography variant="body2">
                            {product.brand || "Agrokart Generic"}
                          </Typography>
                        </ListItem>
                      </List>
                    </Box>
                    ...
                    <Box sx={{ p: 2, bgcolor: "white", borderRadius: 2 }}>
                      ...
                      <Typography paragraph>
                        {product.specifications?.usage ||
                          "Detailed usage instructions will be provided with the packaging."}
                      </Typography>
