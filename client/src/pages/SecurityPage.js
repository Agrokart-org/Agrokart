...
const SecurityPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (newPassword !== confirmPassword) {
      setError(
        t("settingsPage.passwordsDoNotMatch", "New passwords do not match"),
      );
      return;
    }
    ...
    try {
      ...
      setSuccess(
        t(
          "settingsPage.passwordChangedSuccess",
      ...
      if (err.code === "auth/wrong-password") {
        setError(
          t("settingsPage.incorrectPassword", "Incorrect current password"),
        );
      } else if (err.code === "auth/requires-recent-login") {
        setError(
          t(
            "settingsPage.reauthRequired",
        ...
        setError(
          t(
            "settingsPage.passwordChangeError",
        ...
        >
          ...
          >
            ...
            <Typography variant="body2" color="text.secondary" align="center">
              {t(
                "settingsPage.passwordRequirement",
          ...
          <form onSubmit={handleSubmit}>
            ...
            <TextField
              fullWidth
              label={t(
                "settingsPage.confirmNewPassword",
            ...
            >
              {loading ? (
                ...
                t("settingsPage.updatePassword", "Update Password")
              )}
            </Button>
          </form>
        </Paper>
