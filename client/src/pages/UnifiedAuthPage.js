...
const UnifiedAuthPage = () => {
  ...
  const roles = [
    {
      ...
      description:
        "Shop for fertilizers, seeds, tools and get them delivered to your farm",
      icon: CustomerIcon,
      color: "#4CAF50",
    ...
    },
    {
      ...
      description:
        "Register your business and sell agricultural products to farmers",
      icon: VendorIcon,
      color: "#FF9800",
    ...
    },
    {
      ...
      description:
        "Join our delivery network and earn money by delivering products",
      icon: DeliveryIcon,
      color: "#2196F3",
  ...
  const testFirebaseAuth = async () => {
    try {
      ...
      console.log(
        "🧪 Direct Firebase registration successful:",
        userCredential.user,
      );
    ...
    try {
      ...
      if (authMode === "register" && selectedRole === "customer") {
        ...
        if (!testResult.success) {
          throw new Error(
            "Firebase direct test failed: " + testResult.error?.message,
          );
        }
      }
      ...
      if (authMode === "login") {
        ...
        if (selectedRole === "vendor" || selectedRole === "delivery") {
          ...
          try {
            ...
            console.log(
              "🚀 navigate() called to",
              selectedRoleData.registerRoute,
            );
  ...
  return (
    <Box
      sx={{
        minHeight: "100vh",
        background:
          "linear-gradient(135deg, #F0FDF4 0%, #E6F3FF 50%, #F3E8FF 100%)",
        display: "flex",
        alignItems: "center",
        py: 4,
      }}
                          ...
                          >
                            <CardContent sx={{ p: 2 }}>
                              ...
                              >
                                ...
                                >
                                  <IconComponent
                                    sx={{ color: role.color, fontSize: 24 }}
                                  />
                                </Box>
                                <Box sx={{ flex: 1 }}>
