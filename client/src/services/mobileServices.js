...
export class MobileServices {
  ...
  static async initialize() {
    ...
    try {
      ...
      // NOTE: Android back button is handled in App.js via React Router's navigate(-1).
      // Do NOT add a duplicate handler here — it conflicts and causes double-navigation.
