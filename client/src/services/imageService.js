...
class ImageService {
  ...
  getCategoryImages(category) {
    ...
    if (categoryKey.includes("fertilizer"))
      return this.fallbackImages.fertilizer;
    if (categoryKey.includes("seed")) return this.fallbackImages.seeds;
    if (categoryKey.includes("pesticide"))
      return this.fallbackImages.pesticides;
    if (categoryKey.includes("equipment") || categoryKey.includes("implement"))
      return this.fallbackImages.equipment;
  ...
  getResponsiveImages(product) {
    ...
    return {
      thumbnail: this.getOptimizedImageUrl(baseImage, {
        width: 150,
        height: 150,
      }),
