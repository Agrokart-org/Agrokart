...
const initializeSocket = (server) => {
  ...
  io.on("connection", (socket) => {
    ...
    socket.on("join_vendor_room", (vendorId) => {
      ...
      socket.join("all_vendors"); // Ensure they receive broadcasts
    });
    ...
    socket.on("join_delivery_partner_room", (partnerId) => {
      ...
      // Join global delivery partners room for broadcast delivery requests
      socket.join("all_delivery_partners");
    });
